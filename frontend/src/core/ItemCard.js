...
const ItemCard = ({ id, title, description, amount, date, name, category }) => {
      ...
      <Grid container spacing={3} className={classes.root}>
        <Grid item xs={12} sm={5} className={classes.mainRoot}>
          <Box component="div">
            ...
            <Typography variant="subtitle1" style={{ marginBottom: "0.5rem", fontSize: "0.8rem" }}>Category: {category}</Typography>
            <Typography
              variant="subtitle2"
